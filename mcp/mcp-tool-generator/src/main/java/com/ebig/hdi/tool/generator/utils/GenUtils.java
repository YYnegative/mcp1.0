...
import com.ebig.hdi.tool.generator.entity.ColumnEntity;
import com.ebig.hdi.tool.generator.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		for(String template : templates){
			...
			try {
				...
				throw new HdiException("渲染模板失败，表名：" + tableEntity.getTableName(), e);
			}
		}
	}
	...
	public static Configuration getConfig(){
		try {
			...
			throw new HdiException("获取配置文件失败，", e);
		}
	}
