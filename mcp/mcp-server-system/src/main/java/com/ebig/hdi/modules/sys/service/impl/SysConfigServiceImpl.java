...
import com.ebig.hdi.modules.sys.dao.SysConfigDao;
import com.ebig.hdi.modules.sys.entity.SysConfigEntity;
import com.ebig.hdi.modules.sys.redis.SysConfigRedis;
...
public class SysConfigServiceImpl extends ServiceImpl<SysConfigDao, SysConfigEntity> implements SysConfigService {
	...
	public <T> T getConfigObject(String key, Class<T> clazz) {
		...
		try {
			...
			throw new HdiException("获取参数失败");
		}
	}

	@Override
	public SysConfigEntity selectByParamKey(String key) {
