...
import com.ebig.hdi.modules.sys.dao.SysRoleDeptDao;
...
public class SysRoleDeptServiceImpl extends ServiceImpl<SysRoleDeptDao, SysRoleDeptEntity> implements SysRoleDeptService {
	...
	@Override
	public List<Long> queryRoleIdList(Long deptId) {
		return baseMapper.queryRoleIdList(deptId);
	}

	@Override
	public List<SysRoleDeptEntity> selectByRoleIdAndDeptId(Long roleId, Long deptId) {
		return baseMapper.selectByRoleIdAndDeptId(roleId,deptId);
	}

	@Override
	public void deleteByRoleIdAndDeptId(Long roleId, Long deptId) {
		baseMapper.deleteByRoleIdAndDeptId(roleId,deptId);
