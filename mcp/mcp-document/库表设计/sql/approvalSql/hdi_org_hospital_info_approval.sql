...
Date: 2019-11-21 17:50:48
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for hdi_org_hospital_info_approval
-- ----------------------------
DROP TABLE IF EXISTS `hdi_org_hospital_info_approval`;
CREATE TABLE "hdi_org_hospital_info_approval" (
  "id" bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  "parent_id" bigint(1) DEFAULT NULL COMMENT '父医院id',
  "hospital_code" varchar(128) NOT NULL DEFAULT '' COMMENT '医院编码',
  "hospital_grade" int(1) DEFAULT NULL COMMENT '医院级别(0:三级特等;1:三级甲等;2:三级乙等;3:三级丙等;4:二级甲等;5:二级乙等;6:二级丙等;7:一级甲等;8:一级乙等;9:一级丙等)',
  ...
  "child_number" int(11) DEFAULT NULL COMMENT '子机构数(集团医院允许创建的子医院数)',
  ...
  PRIMARY KEY ("id")
) ENGINE=InnoDB AUTO_INCREMENT=79 DEFAULT CHARSET=utf8 COMMENT='医院信息待审批记录表';
